...
for T_loop in range(sample_N):
    ...
    for _ in range(50_000):  # reduced from 1e6 for speed in Streamlit
    ...
    # Magnetization (absolute sum of spins)
    Ferromagneticism.append(abs(np.sum(lattice)))
